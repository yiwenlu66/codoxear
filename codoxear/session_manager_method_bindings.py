...
SESSION_MANAGER_FORWARD_METHODS: tuple[tuple[str, str, str], ...] = (
    ...
    ("list_staged_attachments", "_pending_state_coordinator_for_manager", "list_staged_attachments"),
    ("add_staged_attachment", "_pending_state_coordinator_for_manager", "add_staged_attachment"),
    ("remove_staged_attachment", "_pending_state_coordinator_for_manager", "remove_staged_attachment"),
    ("clear_staged_attachments", "_pending_state_coordinator_for_manager", "clear_staged_attachments"),
