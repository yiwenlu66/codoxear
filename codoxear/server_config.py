...
SERVER_CONFIG_EXPORT_NAMES = (
    ...
    "BROKER_WATCHDOG_SWEEP_SECONDS",
    "BROKER_WATCHDOG_GRACE_SECONDS",
...
class ServerConfig:
    ...
    BROKER_WATCHDOG_SWEEP_SECONDS: float
...
def build_server_config(
    *,
    ...
    return ServerConfig(
        ...
        BROKER_WATCHDOG_SWEEP_SECONDS=30.0,
        BROKER_WATCHDOG_GRACE_SECONDS=60.0,
