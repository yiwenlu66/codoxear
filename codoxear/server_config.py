...
def build_server_config(
    *,
    ...
    return ServerConfig(
        ...
        SIDEBAR_PRIORITY_BUCKET_SECONDS=_env_float(env, "CODEX_WEB_SIDEBAR_PRIORITY_BUCKET_SECONDS", "10.0"),
        RECENT_CWD_MAX=_env_int(env, "CODEX_WEB_RECENT_CWD_MAX", "256"),
        STATIC_CACHE_ENABLED=str(env.get("CODEX_WEB_STATIC_CACHE") or "").strip() == "1",
