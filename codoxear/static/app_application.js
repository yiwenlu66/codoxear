...
import * as CodoxearSettings from "./app_settings.js";
  ...
  function createApplicationController(deps = {}) {
    ...
    const clearTimeout = deps.clearTimeout || window.clearTimeout.bind(window);
      ...
      const applicationComposition = CodoxearApplicationComposition.createApplicationComposition({
        ...
        storageSetItem, storageRemoveItem, codoxearLaunch: CodoxearLaunch, codoxearNewSession: CodoxearNewSession,
        ...
        sidebarRenderSignature, sessionSelectable, diagnosticsProviderDisplay, diagnosticsCopyText, codoxearPolling: CodoxearPolling, codoxearNetwork: CodoxearNetwork, copyConversationFailureToast, normalizeAgentBackendName,
        ...
        codoxearFileEditor: CodoxearFileEditor, normalizeLineNumber, parseLocalFileRef,
