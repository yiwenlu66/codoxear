(function () {
  ...
  function createShellDOM(options = {}) {
    ...
    const topbar = el("div", { class: "topbar" }, [el("div", { class: "pill" }, [toggleSidebarBtn, titleWrap]), el("div", { class: "actions topActions" }, [chatSearchBtn, fileBtn, diagBtn, unattendedBtn, interruptBtn])]);
