...
function requireFunction(value, name) {
  ...
  function createFileViewerController(deps) {
    ...
    const wiring = deps && deps.wiring;
    if (!wiring || typeof wiring.createFileViewerOperationsOptions !== "function") throw new TypeError("file viewer dependency missing: wiring");
    const operations = createFileViewerOperationsRuntime(wiring.createFileViewerOperationsOptions({
      el: deps.el,
      fileStatus: deps.fileStatus,
      fileEditButton: deps.fileEditButton,
      iconSvg: deps.iconSvg,
      currentSessionId: deps.currentSessionId,
      currentFileSessionId: deps.currentFileSessionId,
      normalizeSessionId: normalizeSessionId,
      normalizeFileApiPath: deps.normalizeFileApiPath,
      isFileViewerOpen: deps.isFileViewerOpen,
      hideFileUnsavedDialog: deps.hideFileUnsavedDialog,
      resetFileSearchState: deps.resetFileSearchState,
      closeFilePickerMenu: deps.closeFilePickerMenu,
      isTextFileKind: deps.isTextFileKind,
      isDiffableFileKind: deps.isDiffableFileKind,
      confirmReload: deps.confirmReload,
      promptUnsavedFileChoice: deps.promptUnsavedFileChoice,
      restoreFileEditorText: deps.restoreFileEditorText,
      hideFileViewer: deps.hideFileViewer,
      setFilePath: deps.setFilePath,
      resetFileViewerPanel: deps.resetFileViewerPanel,
      applyFileLoadResult: deps.applyFileLoadResult,
      normalizeDraftFilePath: deps.normalizeDraftFilePath,
      inspectSessionFilePath: deps.inspectSessionFilePath,
      api: deps.api,
      ...
      renderMonacoFile: deps.renderMonacoFile,
      getFileEditorText: deps.getFileEditorText,
      ...
      setFileEditorKind: setFileEditorKind,
      setFileEditMode: setFileEditMode,
      currentActiveFileKind: currentActiveFileKind,
      currentActiveFileText: currentActiveFileText,
      currentActiveFileEditable: currentActiveFileEditable,
      currentActiveFileVersion: currentActiveFileVersion,
      currentActiveFileDraft: currentActiveFileDraft,
      applyActiveFileTextState: applyActiveFileTextState,
      applyActiveFileDiffState: applyActiveFileDiffState,
      applyActiveFileNonTextState: applyActiveFileNonTextState,
      currentActiveFileIdentity: currentActiveFileIdentity,
      currentActiveFileLine: currentActiveFileLine,
      startFileOpenRequest: startFileOpenRequest,
      isCurrentFileOpenRequest: isCurrentFileOpenRequest,
      normalizeExplicitFileOpenMode: normalizeExplicitFileOpenMode,
      resolveFileOpenMode: resolveFileOpenMode,
      isFileOpenAbortError: isFileOpenAbortError,
      activeFileEntry: activeFileEntry,
      isGitFileCandidatePath: isGitFileCandidatePath,
