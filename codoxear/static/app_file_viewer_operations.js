  ...
  function createFileViewerOperationsRuntime(options = {}) {
    ...
    function handleFileEditorSaveShortcut(event) {
      ...
      // The vim-normal gate is deliberately ignored: Ctrl-S saves from vim
      // normal mode. Every other idle-text gate still applies.
      if (!activeFileEditorInsertIdleTextWritable()) return false;
