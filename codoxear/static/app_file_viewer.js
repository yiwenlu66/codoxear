(function () {
  ...
  function createFileViewerController(deps) {
    ...
    const activeFilePath = requireFunction(deps && deps.activeFilePath, "activeFilePath");
    const activeFileLine = requireFunction(deps && deps.activeFileLine, "activeFileLine");
    const activeFileGitPath = requireFunction(deps && deps.activeFileGitPath, "activeFileGitPath");
    const activeFileApiPath = requireFunction(deps && deps.activeFileApiPath, "activeFileApiPath");
