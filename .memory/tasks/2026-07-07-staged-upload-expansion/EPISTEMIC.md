...
- Harden `attachments/clear` against tampered app-dir states by catching symlink-guard `ValueError` as a visible 400 instead of allowing a 500/list-disk divergence.
