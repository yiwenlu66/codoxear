...
class TestOverlayAccessibilitySource(unittest.TestCase):
    ...
    def test_file_viewer_dialog_restores_focus_and_announces_status(self) -> None:
        ...
        self.assertIn("fileViewerModalRuntime.show({ wasOpen, queryOpen, activeElement: document.activeElement, ElementCtor: HTMLElement });", show_block)
        ...
        self.assertIn("return fileUnsavedDialogRuntime.focusInitialControl();", source)
