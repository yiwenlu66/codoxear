...
class TestFileUploadModuleSource(unittest.TestCase):
    ...
    def test_inject_file_route_checks_session_idle_before_staging(self) -> None:
        ...
        self.assertIn("allow_commit_unknown_raw = obj.get(\"allow_commit_unknown\", False)", source)
        self.assertIn("if not isinstance(allow_commit_unknown_raw, bool):", source)
        self.assertIn("allow_commit_unknown = allow_commit_unknown_raw is True", source)
        self.assertIn("allow_orphan_recovery_raw = obj.get(\"allow_orphan_recovery\", False)", source)
        self.assertIn("if not isinstance(allow_orphan_recovery_raw, bool):", source)
        self.assertIn("allow_orphan_recovery = allow_orphan_recovery_raw is True", source)
