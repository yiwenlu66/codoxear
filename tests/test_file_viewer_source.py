...
class TestFileViewerSource(unittest.TestCase):
    ...
    def test_file_viewer_handles_selected_session_removal(self) -> None:
        ...
        self.assertIn("return fileUnsavedDialogRuntime.syncMode();", source)
    ...
    def test_file_editor_capability_predicates_preserve_distinctions(self) -> None:
        ...
        self.assertIn("fileEditorRuntime.restoreFileText(currentFileEditorKind(), restorePlan.text", source)
    ...
    def test_file_open_race_guard_is_wired_through_fetch_and_render(self) -> None:
        ...
        self.assertIn('fileEditorRuntime.scheduleLineFocus("file", requestedLine', source)
        self.assertIn('fileEditorRuntime.scheduleLineFocus("diff", requestedLine', source)
        ...
        self.assertIn("fileFallbackRuntime.renderPlainText(rel, text, lineNumber, reason);", fallback_block)
    ...
    def test_file_save_response_is_bound_to_original_session_and_path(self) -> None:
        ...
        self.assertIn("fileEditorRuntime.restoreFileText(currentFileEditorKind(), restorePlan.text", restore_block)
        self.assertNotIn("model.setValue(restorePlan.text);", source)
        self.assertIn("function restoreFileText(kind, text, runProgrammaticChange)", APP_FILE_EDITOR_JS.read_text(encoding="utf-8"))
