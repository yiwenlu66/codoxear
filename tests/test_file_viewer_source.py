...
class TestFileViewerSource(unittest.TestCase):
    ...
    def test_file_save_response_is_bound_to_original_session_and_path(self) -> None:
        ...
        restore_block = source[source.index("function restoreFileEditorText(text)"):source.index("function timeoutPromise", source.index("function restoreFileEditorText(text)"))]
