...
def render_shell_parents() -> dict[str, str | None]:
    ...
    js = textwrap.dedent(
        ...
        process.stdout.write(JSON.stringify({{
          ...
          chatTime: parentClass(elements.chatTimeChip),
          chatRail: parentClass(elements.chatNavRail),
          stagedTrayParentTag: elements.stagedTray.parent && elements.stagedTray.parent.tag,
          composerInput: parentClass(elements.textarea),
    ...
    def test_message_navigation_controls_mount_in_chat_nav_rail(self) -> None:
        self.assertEqual(
            render_shell_parents(),
            {
                ...
                "chatTime": "chatHeader",
                "chatRail": "chatHeader",
                "stagedTrayParentTag": "form",
                "composerInput": "inputWrap",
