...
def test_file_viewer_wiring_preserves_delete_command_dependency() -> None:
    """The runtime delete shortcut receives its command resolver through wiring."""
...
const options = wiring.createFileViewerOptions({
